export const GALLERY_CONTENT = {
  header: {
    title: 'Hasil Kerja',
    highlight: 'Nyata',
    subtitle: 'Setiap pekerjaan dikerjakan dengan presisi. Ini sebagian dokumentasi layanan kami.',
  },
  items: [
    {
      id: 1,
  ...
  cta: {
    text: 'Punya proyek servis laptop atau PC? ',
    link: 'Hubungi kami sekarang →',
