...
export const testimonials: Testimonial[] = [
  ...
  {
    text: "Langganan Repasta untuk maintenance laptop kantor sudah 2 tahun. Profesional, konsisten, dan selalu on-time. Partner servis terbaik yang pernah saya temui di Bandung.",
    image:
