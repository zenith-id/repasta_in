          ...
          >
            <Card className="relative overflow-hidden h-full border-border hover:border-primary/30 hover:shadow-xl hover:shadow-primary/8 transition-all duration-300 group">
              <CardContent className="pt-8 text-center">
                <div
                  className="relative mx-auto flex aspect-square size-28 rounded-full border border-border items-center justify-center
                  before:absolute before:-inset-2 before:rounded-full before:border before:border-border/40"
                >
                  <Shield
                    className="m-auto h-12 w-12 text-primary"
                    strokeWidth={1.5}
                  />
                </div>
                <div className="mt-7 space-y-1.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Setiap pekerjaan dan spare part dilindungi garansi penuh.
                    Tenang tanpa risiko.
                  </p>
                </div>
            ...
            <Card className="relative overflow-hidden h-full border-border hover:border-primary/30 hover:shadow-xl hover:shadow-primary/8 transition-all duration-300 group">
              <CardContent className="pt-8 text-center">
                ...
                <div className="mt-5 space-y-1.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Diagnosa cepat dalam hitungan jam. Anda tahu kondisi
                    perangkat hari itu juga.
                  </p>
                </div>
            ...
            <Card className="relative overflow-hidden h-full border-border hover:border-primary/30 hover:shadow-xl hover:shadow-primary/8 transition-all duration-300 group">
              <CardContent className="grid sm:grid-cols-2 gap-6 pt-8 h-full">
                <div className="relative z-10 flex flex-col justify-between gap-8">
                  <div
                    className="relative flex aspect-square size-12 rounded-full border border-border items-center justify-center
                    before:absolute before:-inset-2 before:rounded-full before:border before:border-border/40"
                  >
                    <Wrench
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-foreground font-poppins mb-1.5">
                      Layanan Lengkap
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Satu tempat untuk semua kebutuhan servis laptop dan PC
                      Anda.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="grid sm:grid-cols-2 gap-6 pt-8 h-full">
                <div className="relative z-10 flex flex-col justify-between gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Dipercaya ratusan pelanggan di Bandung sejak kami berdiri.
                    </p>
                  </div>
                </div>
