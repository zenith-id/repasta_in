  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      >
        ...
        <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-[8rem] group-hover:ml-2.5 group-active:max-w-[8rem] group-active:ml-2.5 group-focus-visible:max-w-[8rem] group-focus-visible:ml-2.5 transition-all duration-300 text-sm font-semibold">
