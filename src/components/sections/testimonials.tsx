...
export function Testimonials() {
  return (
    <section
      ...
      className="bg-card py-24 relative overflow-hidden content-visibility-auto"
    >
      <motion.div
      ...
      >
        ...
        {/* Scrolling columns */}
        <div
          className="flex justify-center gap-5 mt-10 max-h-[400px] md:max-h-[600px] lg:max-h-[740px] overflow-hidden"
          style={{
            maskImage:
